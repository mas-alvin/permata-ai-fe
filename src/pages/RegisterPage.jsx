...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fcfcfd] text-gray-900 flex antialiased selection:bg-[#800020] selection:text-white">
      <div className="hidden lg:flex lg:w-[48%] relative bg-gradient-to-br from-[#121316] via-[#1a1417] to-[#241318] text-white p-12 flex-col justify-between overflow-hidden">
        ...
        <div className="relative z-10 my-auto py-10 max-w-lg">
          ...
          <p className="text-gray-300 text-base leading-relaxed mb-8">
            Gabung dengan ribuan desainer, engineer, dan inovator produk yang
            membangun masa depan dengan kekuatan AI terpadu.
          </p>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-4 p-3.5 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md">
              ...
              <div>
                <h4 className="text-sm font-bold text-white">
                  Model Penalaran Permata Pro v2.5
                </h4>
                <p className="text-xs text-gray-300 mt-0.5 leading-relaxed">
                  Eksekusi logika kompleks, analisis dokumen, dan arsitektur
                  desain dalam hitungan detik.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-3.5 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md">
              ...
              <div>
                <h4 className="text-sm font-bold text-white">
                  Canvas Workspace & Studio Interaktif
                </h4>
                <p className="text-xs text-gray-300 mt-0.5 leading-relaxed">
                  Ruang kreatif multi-modal dengan integrasi langsung ke Figma,
                  Canva, dan aset cloud Anda.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-3.5 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md">
              ...
              <div>
                <h4 className="text-sm font-bold text-white">
                  Privasi Data & Kepemilikan Penuh
                </h4>
                <p className="text-xs text-gray-300 mt-0.5 leading-relaxed">
                  Data tim Anda dienkripsi penuh dan tidak digunakan untuk
                  melatih model publik tanpa izin.
                </p>
              </div>
            </div>
          </div>
      ...
      <div
        className="flex-1 flex flex-col justify-between p-6 sm:p-10 lg:p-14 min-h-screen overflow-y-auto"
        style={{
          background:
      ...
      >
        ...
        <div className="w-full max-w-md mx-auto my-auto py-6">
          ...
          <div className="grid grid-cols-2 gap-3 mb-5">
            <button
              type="button"
              className="flex items-center justify-center gap-2.5 px-4 py-2.5 bg-white hover:bg-gray-50 border border-gray-200 rounded-xl text-xs sm:text-sm font-medium text-gray-700 shadow-sm transition-all hover:shadow hover:border-gray-300 active:scale-[0.99]"
            >
            ...
            <button
              ...
              className="flex items-center justify-center gap-2.5 px-4 py-2.5 bg-white hover:bg-gray-50 border border-gray-200 rounded-xl text-xs sm:text-sm font-medium text-gray-700 shadow-sm transition-all hover:shadow hover:border-gray-300 active:scale-[0.99]"
            >
              <span className="material-symbols-outlined text-[20px] text-gray-900">
                apple
              </span>
              <span>Apple ID</span>
            </button>
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
            ...
            <div>
              ...
              <div className="mt-2 flex items-center gap-1.5">
                ...
                {passwordStrength.label && (
                  <span
                    className={`text-[11px] font-medium ml-1 ${passwordStrength.textColor}`}
                  >
                    {passwordStrength.label}
                  </span>
                )}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="w-full pl-10 pr-8 py-2.5 bg-white border border-gray-200 rounded-xl text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#800020]/20 focus:border-[#800020] transition-all shadow-sm appearance-none cursor-pointer"
                >
                ...
                <span className="material-symbols-outlined absolute inset-y-0 right-0 pr-3.5 flex items-center text-gray-400 text-[16px] pointer-events-none">
                  expand_more
                </span>
              </div>
            </div>
            ...
            <div className="pt-1">
              <label className="flex items-start gap-2.5 cursor-pointer select-none">
                <input
                  ...
                  className="w-4 h-4 mt-0.5 rounded border-gray-300 accent-[#800020] shrink-0"
                />
            ...
            <div className="pt-2">
              <button
                type="submit"
                disabled={isLoading}
                className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-gradient-to-r from-[#800020] to-[#5e0017] hover:from-[#6d001b] hover:to-[#4e0013] text-white rounded-xl text-sm font-semibold shadow-lg shadow-rose-950/20 active:scale-[0.99] transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isLoading ? (
                  <>
